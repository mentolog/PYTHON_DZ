...
if __name__ == "__main__":
    print("Получаем список проектов перед запуском негативных тестов...")
    get_projects()  # Получаем список проектов перед тестами
    print("Запускаем негативные тесты...")
    test_create_project_without_title()  # Запускаем негативные тесты
    test_get_project_with_invalid_id()
    test_delete_project_with_invalid_id()
    print("Получаем список проектов после запуска негативных тестов...")
